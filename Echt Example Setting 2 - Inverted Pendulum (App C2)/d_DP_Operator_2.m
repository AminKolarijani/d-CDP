function [J, Mu] = d_DP_Operator_2(ProblemData, dpData, J_next)
% This function contains the implementation of the d-DP operation for SETTING 2; 
...
while ~ready % loop over x \in X
    ...
    cost_at_U = eval_func_constr(@(u) (cost_x(x)+cost_u(u)), U, @(u) (feasibility_t(x,u)));
