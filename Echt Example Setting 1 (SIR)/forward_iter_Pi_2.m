function [x,u,traj_cost,run_time] = forward_iter_Pi_2(ProblemData, Pi_t)
...
% the discrete state.
% Please see Sections 3 and 5 of the following article for more details:
%   
...
if (constr_x(x(:,T+1)) <=0) 
    cost_T_value = cost_T(x(:,T+1));
else
    cost_T_value = inf;
end
traj_cost = traj_cost + cost_T_value;
